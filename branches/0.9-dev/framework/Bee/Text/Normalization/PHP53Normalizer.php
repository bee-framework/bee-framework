...
class Bee_Text_Normalization_PHP53Normalizer implements Bee_Text_Normalization_INormalizer {
	...
	private static $formMapping = array(
		...
		self::UNICODE_NORMALIZATION_DECOMPOSED => Normalizer::FORM_D,
		self::UNICODE_NORMALIZATION_COMPATIBLE_COMPOSED => Normalizer::FORM_KC,
		self::UNICODE_NORMALIZATION_COMPATIBLE_DECOMPOSED => Normalizer::FORM_KD
	);
	...
	public function normalize($input, $form = self::UNICODE_NORMALIZATION_COMPOSED) {
		return Normalizer::normalize($input, self::$formMapping[$form]);
	}
}
