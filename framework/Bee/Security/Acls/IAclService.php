...
interface IAclService {
     ...
     *
     * @abstract
     * @param IObjectIdentity $parentIdentity to locate children of
     * @return IObjectIdentity[] the children (or <tt>null</tt> if none were found)
     */
     ...
     *
     * @param IObjectIdentity $object to locate an {@link Acl} for
     * @return IAcl the {@link Acl} for the requested {@link IObjectIdentity} (never <tt>null</tt>)
     ...
     *
     * @param IObjectIdentity $object to locate an {@link Acl} for
     * @param array $sids the security identities for which  {@link Acl} information is required
     ...
     * have a map key.</p>
     *
     * @param mixed $objects the objects to find {@link Acl} information for
     * @return IAcl[] a map with exactly one element for each {@link ObjectIdentity} passed as an argument (never <tt>null</tt>)
	 ...
	 *
	 * @abstract
	 * @param IObjectIdentity[] $objects the objects to find {@link Acl} information for
	 * @param ISid[] $sids the security identities for which  {@link Acl} information is required
	 *        (may be <tt>null</tt> to denote all entries)
	 * @param bool $check
	 * @return IAcl[] a map with exactly one element for each {@link IObjectIdentity} passed as an argument (never <tt>null</tt>)
	 */
