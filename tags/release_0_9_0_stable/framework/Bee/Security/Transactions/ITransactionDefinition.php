...
interface Bee_Transactions_ITransactionDefinition {
     ...
     * @return int the propagation behavior
     * @see #PROPAGATION_REQUIRED
     * @see org.springframework.transaction.support.TransactionSynchronizationManager#isActualTransactionActive()
     */
    function getPropagationBehavior();
     ...
     * @return int the transaction timeout
     */
    function getTimeout();
     ...
     * @return boolean <code>true</code> if the transaction is to be optimized as read-only
     ...
     * (by default).
     * @return string the name of this transaction
