...
class ProviderFile extends AbstractSerializingProvider {
	...
	private function getCacheFileName() {
        $dir = $this->cacheDir;
        if (Strings::hasText($dir) && !preg_match('#'.DIRECTORY_SEPARATOR.'$#i', $dir)) {
            $dir .= DIRECTORY_SEPARATOR;
        }
		$tmpName = $dir . $this->cacheFile . (Framework::getApplicationId() ? '_'.Framework::getApplicationId() : '');
		return $tmpName;
	}
