 ...
 */
class Bee_Context_Support_BeanDefinitionReaderUtils {
	 ...
	 *
	 * @param parentName $parentName the name of the parent bean, if any
	 * @param className $className the name of the bean class, if any
	 ...
	 * given bean factory.
	 *
	 * @param Bee_Context_Config_IBeanDefinition $definition the bean definition to generate a bean name for
	 * @param Bee_Context_Config_IBeanDefinitionRegistry $registry the bean factory that the definition is going to be
	 * registered with (to check for existing bean names)
	 * @param isInnerBean $isInnerBean whether the given bean definition will be registered
	 * as inner bean or as top-level bean (allowing for special name generation
	 * for inner beans versus top-level beans)
	 * @return String the generated bean name
	 */
	public static function generateBeanName(
			Bee_Context_Config_IBeanDefinition $definition, Bee_Context_Config_IBeanDefinitionRegistry $registry, $isInnerBean = false) {
...
//		}
	 ...
	 *
	 * @param Bee_Context_Config_BeanDefinitionHolder $definitionHolder
	 * @param Bee_Context_Config_IBeanDefinitionRegistry $registry
	 * @return void
	 */
	public static function registerBeanDefinition(
			Bee_Context_Config_BeanDefinitionHolder $definitionHolder, Bee_Context_Config_IBeanDefinitionRegistry $registry) {
